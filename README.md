...
# print("O quadrado do numero é",numero*numero)
...
# print("Os numeros concatenados sao ", n1+n2)
...
# b1 = '2ovos'
# b2 = '200g de farinha de trigo'
# b3 = 'fermento'
# b4 = '1 xicara de leite'
# b5 = '6 colheres de sopa de chocolate em pó'
# b6 = 'uma colher de sopa de manteiga'
 

# print("Para fazer um bolo voce precisa de:",b1+',',b2+',',b3+',',b4+',',b5+',',b6)
...
# usuario1 = input('Cite uma qualidade que voce ache que as pessoas gostam em voce - ')
# usuario2 = input('o que voce mais faz para agradar as pessoas - ')
# usuario3 = input("Como voce se sente em relação a isso ? - ")
